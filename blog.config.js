...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '比木', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '18岁的老年人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bimu.me/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '比木', // 网站关键词 英文逗号隔开
